...
add_library(${SYSTEM_PROJECT_NAME} INTERFACE
...
target_include_directories(${SYSTEM_PROJECT_NAME} INTERFACE include)
target_link_libraries(${SYSTEM_PROJECT_NAME} INTERFACE EnTT ${SCENE_PROJECT_NAME})
